...
public class Cliente {
    ...
    //DATOS PERSONALES
    @ManyToOne
    @JoinColumn(name = "genero_gen", foreignKey = @ForeignKey(name = "FK_cli_genero_generoGen"))
    private Genero genero;

    private LocalDate fechaNacimiento;

    @ManyToOne
    @JoinColumn(name = "nombre_Pais", foreignKey = @ForeignKey(name = "FK_cli_pais_nombrePais"))
    private Pais pais;
    ...
    //DATOS DE CONTACTO
    @OneToOne
    @JoinColumn(name = "direccion_personal", foreignKey = @ForeignKey(name = "FK_cli_direccion_direccionPersonal"))
    ...
    //DATOS DE CLIENTE
    @OneToOne
    @JoinColumn(name = "email_usuario", foreignKey = @ForeignKey(name = "FK_cli_usuario_usuarioEmail"))
    ...
    @ManyToOne
    @JoinColumn(name = "tipo_Cliente", foreignKey = @ForeignKey(name = "FK_cli_tipoCli_tipoCli"))
    ...
    @OneToOne
    @JoinColumn(name = "id_auditoria", foreignKey = @ForeignKey(name = "FK_cli_auditoria_idAuditoria"))
    ...
    public void addTarjetaCredito(TarjetaCredito tarjetaCredito) {
        tarjetaCredito.setCliente(this); // Establece la relación bidireccional
